...
export class InitSchema1765889230858 implements MigrationInterface {
    name = 'InitSchema1765889230858'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "email" character varying NOT NULL, "passwordHash" text, "provider" "public"."users_provider_enum" NOT NULL DEFAULT 'local', "roles" text array NOT NULL DEFAULT '{}', "oauthId" text, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
